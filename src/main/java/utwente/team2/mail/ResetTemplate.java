...
//        return null;
    ...
    private static String part2 = "</span></strong></span></p>" +
            ...
            "<div style=\"font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 18px; color: #283C4B;\">" +
            "<p style=\"font-size: 12px; line-height: 24px; text-align: center; margin: 0;\"><span style=\"font-size: 16px;\">You're receiving this email because you requested a password reset for your user account on Runner. If you didn't request a password change, you can just ignore this message.</span></p>" +
            "</div>" +
            "</div>" +
            "<!--[if mso]></td></tr></table><![endif]-->" +
